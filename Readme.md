...
## **Contributors**
  •	Himashaili Donavalli (hd3q): Database setup, frontend UI design, AES-256 encryption, audit logging.
  •	Aishwarya Reddy Sarsan (as2qm): Backend integration, frontend UI, RBAC implementation, MFA setup.
  •	Sai Preetham Surabhi (ss2kn): SHA-256 password hashing, SQL injection prevention, UI improvements.
